let array = ['5 kilos','pera','naranja','melocotón','10 kilos'];
...
dataExercise = {
    ...
    procesar: "result_tipo_2_2_31()", //tal cual esta en la funcion result_tipo_x_x_x() de la parte inferior del archivo index o el archivo validate
