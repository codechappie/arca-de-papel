...
dataExercise = {
    next: "../12/index.html", // Siguiente ejercicio
    procesar: "result_tipo_2_2_13()", //tal cual esta en la funcion result_tipo_x_x_x() de la parte inferior del archivo index o el archivo validate
