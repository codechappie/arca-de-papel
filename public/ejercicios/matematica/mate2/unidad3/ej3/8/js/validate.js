...
dataExercise = {
    ...
    procesar: "result_tipo_2_2_10()", //tal cual esta en la funcion result_tipo_x_x_x() de la parte inferior del archivo index o el archivo validate
...
$('.a').click(function () {
    ...
    if (valor != 1) {
        ...
        $(this).css({
            "background-color": "silver", "background-color": "rgba(254, 205, 84, 0.65)", "border": "solid white",
