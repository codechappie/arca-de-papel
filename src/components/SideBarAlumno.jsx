...
const SideBarAlumno = () => {
    ...
    const {nombres, apellidos, cursos,imagenPerfil} = useSelector(store=>store.usuario) 
                    ...
                    <div className="items-container">
                        ...
                        <div className="item-container">
                            <div className={`item ${mostrarSalones && 'active'}`}
                                ...
                                <h5>Mis salones ({cursos.length})</h5>
                            </div>
                            <div 
                            className={`item-details ${showItems ? '' : 'dont-show-items'}`}>

                                {
                                    cursos.map(curso => (
                                        ...
                                        <div className="sub-item" key={curso.id} onClick={clasesSalonesActivo}>
                                            <Link to={classromLink.concat(curso.id)} >
                                                <span className={curso.color}> </span>
                                                <h5>{curso.curso} {curso.grado}°- {curso.seccion}</h5>
                                            </Link>
                                        </div>
                                    ))
                                }
                        ...
                        <div className="item-container">
                            <Link to="/streamming" target="_blank" className={`item ${mostrarStreamming && 'active'}`} onClick={clasesStreammingActivo}>
